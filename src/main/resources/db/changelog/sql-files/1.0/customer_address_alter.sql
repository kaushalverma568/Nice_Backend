ALTER TABLE CUSTOMER_ADDRESS ADD COLUMN IF NOT EXISTS BLOCK CHARACTER VARYING(255) NOT NULL DEFAULT '';
...
(
    ...
    ALLOCATED_FOR CHARACTER VARYING(255) COLLATE PG_CATALOG."DEFAULT" NOT NULL,
	...
	CONSTRAINT STOCK_ALLOCATION_ORDER_ITEM_FK FOREIGN KEY (ORDER_ITEM_ID) REFERENCES ORDER_ITEM(ID),
