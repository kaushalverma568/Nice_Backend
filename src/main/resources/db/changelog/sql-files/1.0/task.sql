...
(
	...
	DELIVERY_BOY_PAYMENT_DETAILS_ID BIGINT,
	...
	VENDOR_PAYMENT_DETAILS_ID BIGINT,
	...
	CONSTRAINT TASK_PAYMENT_FK FOREIGN KEY (DELIVERY_BOY_PAYMENT_DETAILS_ID) REFERENCES PAYMENT_DETAILS(ID),
	CONSTRAINT VEND_FK FOREIGN KEY (VENDOR_ID) REFERENCES VENDOR(ID),
	CONSTRAINT VEND_PAY_FK FOREIGN KEY (VENDOR_PAYMENT_DETAILS_ID) REFERENCES PAYMENT_DETAILS(ID)	
);
