...
(
    ...
    UPDATED_BY BIGINT NOT NULL,  
    CATEGORY_ID BIGINT NOT NULL,
    DESCRIPTION_ENGLISH CHARACTER VARYING(255) NOT NULL,
    ...
    CONSTRAINT PROD_BUSS_CAT_FK FOREIGN KEY (BUSINESS_CATEGORY_ID) 
...
(
    ...
    CONSTRAINT TOPPING_PKEY PRIMARY KEY (ID),
   	CONSTRAINT TOPPING_VENDOR FOREIGN KEY (VENDOR_ID)
        REFERENCES VENDOR (ID),
	CONSTRAINT TOPPING_NAME_ENGLISH_UNIQUE UNIQUE(VENDOR_ID, NAME_ENGLISH),
	CONSTRAINT TOPPING_NAME_ARABIC_UNIQUE UNIQUE(VENDOR_ID, NAME_ARABIC)
);
...
(
	...
	CONSTRAINT ADDONS_VENDOR FOREIGN KEY (VENDOR_ID)
		REFERENCES VENDOR (ID),
	CONSTRAINT VENDOR_ADDONS_NAME_ENGLISH_UNIQUE UNIQUE(VENDOR_ID, NAME_ENGLISH),
	CONSTRAINT VENDOR_ADDONS_NAME_ARABIC_UNIQUE UNIQUE(VENDOR_ID, NAME_ARABIC)
);
...
(
	...
	CONSTRAINT PRODUCT_ATTR_VENDOR_FK FOREIGN KEY (VENDOR_ID)
        REFERENCES VENDOR (ID),
    CONSTRAINT PRODUCT_ATTR_ENGLISH_VENDOR_NAME_UNQ UNIQUE(VENDOR_ID, NAME_ENGLISH),
    CONSTRAINT PRODUCT_ATTR_ARABIC_VENDOR_NAME_UNQ UNIQUE(VENDOR_ID, NAME_ARABIC)
);
...
CREATE TABLE IF NOT EXISTS PRODUCT_ATTRIBUTE_VALUES(
    ...
    ATTRIBUTE_VALUE_ENGLISH CHARACTER VARYING(255) NOT NULL,
    ATTRIBUTE_VALUE_ARABIC CHARACTER VARYING(255) NOT NULL,
    PRODUCT_VARIANT_ID BIGINT NOT NULL, 
    DESCRIPTION_ENGLISH CHARACTER VARYING(255),
    DESCRIPTION_ARABIC TEXT,
    RATE  NUMERIC(10,2) NOT NULL,
	...
	CONSTRAINT PRODUCT_PRODUCT_ATTR_VALUE_FK FOREIGN KEY (PRODUCT_VARIANT_ID)
        REFERENCES PRODUCT_VARIANT (ID),
    CONSTRAINT PROD_ATTR_VAL_VARIANT_ATTR_ENGLISH_VAL_UNQ UNIQUE(PRODUCT_ATTRIBUTE_ID, ATTRIBUTE_VALUE_ENGLISH, PRODUCT_VARIANT_ID),
    CONSTRAINT PROD_ATTR_VAL_VARIANT_ATTR_ARABIC_VAL_UNQ UNIQUE(PRODUCT_ATTRIBUTE_ID, ATTRIBUTE_VALUE_ARABIC, PRODUCT_VARIANT_ID)
);
