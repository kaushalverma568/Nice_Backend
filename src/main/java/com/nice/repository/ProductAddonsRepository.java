...
public interface ProductAddonsRepository extends JpaRepository<ProductAddons, Long> {
	 ...
	 * @return
	 */
	List<ProductAddons> findAllByProductVariantAndActiveOrderByRateAsc(ProductVariant productVariant, Boolean activeRecords);

	/**
	 * @param productVariant
	 * @return
	 */
	List<ProductAddons> findAllByProductVariantOrderByRateAsc(ProductVariant productVariant);

	/**
	 * @param addons
	 * @return
	 */
	List<ProductAddons> findAllByAddonsOrderByRateAsc(Addons addons);
}
