...
public class CategoryServiceImpl implements CategoryService {
	...
	public Page<Category> getCategoryList(final Integer pageNumber, final Integer pageSize, final Boolean activeRecords, final String searchKeyword,
		...
		if (vendorId != null) {
			...
			return findByActiveAndName(activeRecords, searchKeyword, pageable);
		}
	}

	private Page<Category> findByActiveAndName(final Boolean activeRecords, final String searchKeyword, Pageable pageable) {
		if (activeRecords != null) {
			if (searchKeyword != null) {
	...
	public Boolean isCategoryExistsEnglish(final CategoryDTO categoryDTO) throws NotFoundException {
		...
		if (categoryDTO.getId() != null) {
			/**
			 * At the time of update is category with same name(English) exist or not except
			 * it's own id
			 */
	...
	public Boolean isCategoryExistsArabic(final CategoryDTO categoryDTO) throws NotFoundException {
		...
		if (categoryDTO.getId() != null) {
			/**
			 * At the time of update is category with same name(Arabic) exist or not except
			 * it's own id
			 */
