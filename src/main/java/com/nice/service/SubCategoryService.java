...
public interface SubCategoryService {
	...
	/**
	 * delete sub category by sub categoryId
	 *
	 * @param subCategoryId
	 * @throws NotFoundException
	 * @throws ValidationException
	 */
	void deleteSubCategory(Long subCategoryId) throws NotFoundException, ValidationException;
	 ...
	 * @throws IOException
	 */
	void exportSubCategoryList(HttpServletResponse httpServletResponse) throws FileOperationException;
