...
public interface TaskService {
	 ...
	 * @return
	 */
	Long getTaskCountBasedOnParams(TaskFilterDTO taskFilterDTO, Boolean isFromScheduler);
	...
	void removeLocationDetailsAndUpdateDeliveryBoyAfterCompleteTask(Task task) throws NotFoundException;

	/**
	 * get latest task for order
	 *
	 * @param  orderId
	 * @return
	 */
	...
	/**
	 * send one manual hit to socket after delivery of order to notify customer about delivery
	 *
	 * @throws NotFoundException
	 */
	 ...
	 * @return
	 */
	Optional<Task> getTaskDetailForOrderIdAndAllocatedFor(Orders order, String allocatedFor);
}
