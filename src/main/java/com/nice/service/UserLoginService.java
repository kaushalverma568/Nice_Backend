...
public interface UserLoginService {
	 ...
	 * @throws ValidationException
	 */
	void checkPasswordForUser(UserCheckPasswordDTO userCheckPasswordDTO) throws ValidationException;
	...
	/**
	 * send push notification for new profile validate to admin
	 *
	 * @param entityId
	 * @param entityType
	 * @throws NotFoundException
	 */
	void sendPushNotificationForNewProfile(Long entityId, String entityType) throws NotFoundException;

	/**
	 * get super admin login details:this method is used internally
	 *
	 * @return
	 * @throws NotFoundException
	 * @throws ValidationException
	 */
	UserLogin getSuperAdminLoginDetail() throws NotFoundException, ValidationException;
}
