...
public class OrdersController {
	...
	public ResponseEntity<Object> retryForSearchingDeliveryBoys(@RequestHeader("Authorization") final String accessToken, @PathVariable final Long orderId,
			@RequestParam("repeatDeliveryBoy") final Boolean repeatDeliveryBoy) throws NotFoundException, ValidationException {
		LOGGER.info("retry for searching delivery boys, orderId:{} and repeatDeliveryBoy:{} ", orderId, repeatDeliveryBoy);
		orderService.retryForSearchingDeliveryBoys(orderId, repeatDeliveryBoy);
